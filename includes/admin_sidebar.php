...
if (isset($_SESSION['user_id'])) {
    ...
    if (!empty($sidebar_user) && !empty($sidebar_user[0]['profile_picture'])) {
        $sidebar_profile_pic = get_profile_image($sidebar_user[0]['profile_picture']);
    }
...
<div id="printflow-persistent-sidebar" data-turbo-permanent>
    ...
    <aside class="sidebar" id="adminSidebar">
        <div class="sidebar-header">
            <a href="/printflow/admin/dashboard.php" class="logo">
                ...
                <span
                    style="word-wrap: break-word; overflow-wrap: break-word; white-space: normal; line-height: 1.3;"><?php echo $shop_name; ?></span>
            </a>
            <button id="global-sidebar-toggle" class="sidebar-collapse-btn" onclick="toggleSidebar()"
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="/printflow/admin/dashboard.php"
                ...
                <a href="/printflow/admin/orders_management.php"
                    class="nav-item <?php echo $current_page === 'orders_management.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/customizations.php"
                    class="nav-item <?php echo in_array($current_page, ['job_orders.php', 'customizations.php']) ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/customers_management.php"
                    class="nav-item <?php echo $current_page === 'customers_management.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/products_management.php"
                    class="nav-item <?php echo $current_page === 'products_management.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                    </svg>
                ...
                <a href="/printflow/admin/services.php"
                    class="nav-item <?php echo in_array($current_page, ['services.php', 'services_management.php'], true) ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/inv_items_management.php"
                    class="nav-item <?php echo in_array($current_page, ['inv_items_management.php', 'inventory_management.php']) ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/inv_transactions_ledger.php"
                    class="nav-item <?php echo in_array($current_page, ['inv_transactions_ledger.php', 'inventory_monthly.php']) ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/branches_management.php"
                    class="nav-item <?php echo $current_page === 'branches_management.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/reports.php"
            ...
            <div class="nav-section">
                ...
                <a href="/printflow/admin/user_staff_management.php"
                    class="nav-item <?php echo in_array($current_page, ['user_staff_management.php', 'create_manager.php']) ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/faq_chatbot_management.php"
                    class="nav-item <?php echo $current_page === 'faq_chatbot_management.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="/printflow/admin/notifications.php"
                    class="nav-item <?php echo $current_page === 'notifications.php' ? 'active' : ''; ?>">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                    </svg>
                    Notifications
                    <span id="sidebar-notif-badge" data-notif-badge class="nav-badge"
                        style="visibility:<?php echo ($unread_notif_count > 0 ? 'visible' : 'hidden'); ?>;"><?php echo $unread_notif_count > 99 ? '99+' : ($unread_notif_count > 0 ? (int) $unread_notif_count : ''); ?></span>
                </a>
                <a href="/printflow/admin/settings.php"
            ...
            <div class="nav-section">
                ...
                <a href="/printflow/admin/activity_logs.php"
            ...
            <div class="nav-section">
                ...
                <a href="/printflow/admin/profile.php"
        ...
        <div class="sidebar-footer">
            <a href="/printflow/admin/profile.php" class="user-profile"
                ...
                <div class="user-avatar" style="flex-shrink:0; overflow:hidden;">
                    <?php if ($sidebar_profile_pic): ?>
                        <img src="<?php echo $sidebar_profile_pic; ?>?t=<?php echo time(); ?>" alt=""
                ...
                <div class="user-info" style="min-width:0;">
                    <div class="user-name-display" style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">
                        <?php echo htmlspecialchars($user_name); ?></div>
                    <div class="user-role"><?php echo htmlspecialchars($_SESSION['user_type'] ?? 'Admin'); ?></div>
                </div>
            </a>
            <button onclick="document.getElementById('logoutModal').style.display='flex'" class="logout-btn-footer"
                title="Log out">
    ...
    <div id="logoutModal"
        ...
        <div
            style="background:white; border-radius:16px; padding:32px; width:100%; max-width:380px; margin:16px; box-shadow:0 25px 50px rgba(0,0,0,0.25); text-align:center;">
            <div
            ...
            <p style="font-size:14px; color:#6b7280; margin:0 0 24px;">Are you sure you want to log out of your admin
                account?</p>
            <div style="display:flex; gap:10px;">
                <button onclick="document.getElementById('logoutModal').style.display='none'"
                    style="flex:1; padding:10px; border:1px solid #e5e7eb; background:white; border-radius:8px; font-size:14px; font-weight:600; color:#374151; cursor:pointer; transition:background 0.2s;"
                    onmouseover="this.style.background='#f9fafb'"
                    onmouseout="this.style.background='white'">Cancel</button>
                <a href="/printflow/logout/" data-turbo="false"
                    style="flex:1; padding:10px; background:#ef4444; border:none; border-radius:8px; font-size:14px; font-weight:600; color:white; cursor:pointer; text-decoration:none; display:flex; align-items:center; justify-content:center; transition:background 0.2s;"
                    onmouseover="this.style.background='#dc2626'" onmouseout="this.style.background='#ef4444'">Log
                    Out</a>
            </div>
        </div>
    </div>
